# AGENTS.md — bost-connes

## Role: BSD-RH-CLUSTER / BOST-CONNES

**Cluster:** BSD/RH

**Core claim:** Bost-Connes system M1–M3: connects L-functions, class-field theory, and ζ-symmetries across clusters
...
expressed in the language of BSD/RH.

## Entry point for AI agents

Look for files in `Src/` or the Lean files at repo root.

## Siblings in this cluster

| Repo | Role |
|------|------|
| [DavidFox998/birch-swinnerton-dyer-143](https://github.com/DavidFox998/birch-swinnerton-dyer-143) | sibling in cluster |
| [DavidFox998/birch-swinnerton-dyer-143a1](https://github.com/DavidFox998/birch-swinnerton-dyer-143a1) | sibling in cluster |
